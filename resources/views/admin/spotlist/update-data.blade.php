            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="{{ route('admin.spotlist.excel.store')}}" method="post" enctype="multipart/form-data" >
                        @csrf
                        <div class="row">
                            ...
                            <a href="{{ route('admin.list.spotlist.excel') }}" class="btn btn-common btn-primary">Spot List</a>
                            </div>
                            <div class="col-md-8">
